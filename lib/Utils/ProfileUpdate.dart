                        ...
                        children: [
                          Align(
                            child: GestureDetector(
                              ...
                              child: (controller.imageProfile.value != "")
                                  ? CircleAvatar(
                                      radius: Get.width * .2,
              ...
              WidgetHelper.softButton(
                ...
                onTap: () {
                  if (controller.oldPass.text.isEmpty) {
                    ...
                    ViewHelper.showErrorDialog("Please enter confirm password");
                  } else {
                    if (controller.reNewPass.text == controller.newPass.text) {
                      controller.changePassWord();
                    } else {
                      ViewHelper.showErrorDialog("Confirm password incorrect");
                    }
                  }
                },
              ),
